...
class _RegisterEmployeePageState extends State<RegisterEmployeePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarComponent(
        textAppBar: title_register_employee,
        onPressed: () {
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            height: 80,
            child: TextFieldMain(
              hintText: textfield_hint_id_business,
              labelText: textfield_label_id_bussiness,
  ...
  void _registerUser() {
    if (emailController.text.isNotEmpty &&
        ...
        idNegocioController.text.isNotEmpty) {
      ...
      newUser.idNegocio = idNegocioController.text;
