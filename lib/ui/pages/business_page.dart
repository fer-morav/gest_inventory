...
import '../../ui/components/ButtonMain.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ButtonMain(
                        ...
                        isDisabled: true,
                        onPressed: () {
                          _nextScreenArgs(list_employees_route, _business!.id, _userPosition.toString());
                        },
                      ),
                    ],
                  ),
      ...
      floatingActionButton: Visibility(
        ...
        visible: _userPosition == "[Administrador]" ? true : false,
      ),
    );
  }
  ...
  void _getBusiness(String id) async {
    Business? result = await showDialog(
      ...
      builder: (_) => FutureProgressDialog(
        BlocProvider.of<BusinessCubit>(context).getBusiness(id),
      ),
    );
