...
const button_ambos = "Ambos";
const button_hoy = "Hoy";
const button_semana = "Semana";
const button_mes = "Mes";
const button_statistics = " Estadisticas";
const button_masvendidos = "Más Vendidos";
const button_menosvendidos = "Menos Vendidos";
...
const textfield_label_number_phone = "Telefono";
...
const textfield_hint_address = "Ingrese la dirección del negocio";
